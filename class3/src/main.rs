...
// __________________________________________part 2 enum______________________________________________________
...
// _________________________________ part 3 vec, some iter thingy ______________________________________

// vec

// fn main(){
//     let  a : Vec<u8> = Vec::new(); //1.Sử dụng new() method
//     let  b: Vec<u32> = vec![]; //2. Sử dụng vec! macro
...
//     // for i in &mut v {
//     //     println!("A mutable reference to {}", *i+1);
//     // }
...
//________________________________________generic type____________________________________________
...
//______________________________________exercises____________________________________________________
...
// fn main(){
//     let plastic = Wrapper::<String>::new("hihi".to_string());
//     println!("{:?}",plastic);
// }
